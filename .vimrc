...
if ! isdirectory(s:bundle_root)
  ...
  silent call mkdir(s:bundle_root, 'p')
  silent !git clone https://github.com/Shougo/neobundle.vim s:neobundle_root
  echo 'done.'
  if v:shell_error
...
function! s:loads_bundles() abort
  ...
  " Enable asynchronous processing in vim
...
if neobundle#tap('vimperator-labs')
  " Config {{{
  call neobundle#config( {
        \   'name': 'vimperator-syntax',
        \   'rtp':  'vimperator/contrib/vim/'
